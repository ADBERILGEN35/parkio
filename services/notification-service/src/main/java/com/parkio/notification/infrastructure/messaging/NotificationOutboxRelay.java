...
/**
 * In-process transactional-outbox relay for notification-service. Polls unpublished
 * {@code outbox_events}, wraps each in the transport envelope and publishes it to
 * {@code parkio.notification.notification} keyed by the notification id, then marks the row published —
...
public class NotificationOutboxRelay {
    ...
    public NotificationOutboxRelay(OutboxEventJpaRepository outbox,

...
/** JPA mapping for {@code daily_analytics_snapshots}. */
@Entity
@Table(name = "daily_analytics_snapshots")
public class DailyAnalyticsSnapshotEntity {
    ...
    protected DailyAnalyticsSnapshotEntity() {
        // for JPA
    }

    public DailyAnalyticsSnapshotEntity(UUID id, LocalDate snapshotDate, AnalyticsMetricType metricType,

...
/**
 * Maps domain {@link AnalyticsException}s, request errors and infrastructure errors
 * to consistent API error bodies (ai-context/04). HTTP status lives here — the
...
public class GlobalExceptionHandler {
    ...
    /** Database constraint violation (e.g. a duplicate source-event race). */
    ...
    private static HttpStatus statusFor(AnalyticsErrorCode code) {
        return switch (code) {

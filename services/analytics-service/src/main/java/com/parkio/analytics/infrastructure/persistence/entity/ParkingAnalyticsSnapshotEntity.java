...
/** JPA mapping for {@code parking_analytics_snapshots}. */
@Entity
@Table(name = "parking_analytics_snapshots")
public class ParkingAnalyticsSnapshotEntity {
    ...
    protected ParkingAnalyticsSnapshotEntity() {
        // for JPA
    }

    public ParkingAnalyticsSnapshotEntity(UUID id, AnalyticsMetricType metricType, long eventCount,

    ...
    private static HttpStatus statusFor(UserErrorCode code) {
        return switch (code) {
            case PROFILE_NOT_FOUND, SAVED_PLACE_NOT_FOUND, SAVED_PLACES_DISABLED, SMART_RETURN_DISABLED,
                    ...
                    RECENTS_DISABLED, RECENT_DESTINATION_NOT_FOUND, RECENT_PARKING_NOT_FOUND
            ...
            case UNSUPPORTED_FAVOURITE_TARGET, INVALID_RECENT_DESTINATION, INVALID_RECENT_PARKING_TARGET,
                    UNSUPPORTED_RECENT_PARKING_TARGET

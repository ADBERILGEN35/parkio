...
@TestPropertySource(properties = "parkio.registration.mode=closed")
class RegistrationModeClosedFixtureSecurityTest {
    ...
    @Test
    void pa01b_closedModeAnonymousGet() throws Exception {

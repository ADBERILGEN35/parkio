...
/** Unit tests for the parking→moderation consumer: dispatch, ignore, ack. */
class ParkingEventsKafkaConsumerTest {
    ...
    void dispatchesParkingSpotRejectedAndAcks() throws Exception {
        ...
        // Producer-only field must be tolerated.
    ...
    void ignoresUnsupportedEventTypeButStillAcks() throws Exception {
        ...
        consumer.onMessage(record(UUID.randomUUID(), spotId, "ParkingSpotCreated", payload),

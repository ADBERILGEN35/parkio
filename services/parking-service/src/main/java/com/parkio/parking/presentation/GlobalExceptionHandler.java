...
public class GlobalExceptionHandler {
    ...
    private static HttpStatus statusFor(ParkingErrorCode code) {
        return switch (code) {
            case SPOT_NOT_FOUND, PARKING_SESSION_NOT_FOUND, RECOMMENDATIONS_DISABLED -> HttpStatus.NOT_FOUND;
            case INVALID_PARKING_SESSION_CURSOR, INVALID_DESTINATION, INVALID_RECOMMENDATION_RADIUS,
                    INVALID_RECOMMENDATION_LIMIT, INVENTORY_SELECTION_REQUIRED -> HttpStatus.BAD_REQUEST;

...
public class GlobalExceptionHandler {
    ...
    private static HttpStatus statusFor(ParkingErrorCode code) {
        return switch (code) {
            case SPOT_NOT_FOUND, PARKING_SESSION_NOT_FOUND, RECOMMENDATIONS_DISABLED,
                    RANKING_EVALUATION_NOT_FOUND -> HttpStatus.NOT_FOUND;
            case INVALID_PARKING_SESSION_CURSOR, INVALID_DESTINATION, INVALID_RECOMMENDATION_RADIUS,
                    INVALID_RECOMMENDATION_LIMIT, INVENTORY_SELECTION_REQUIRED,
                    INVALID_RANKING_EVALUATION_OUTCOME -> HttpStatus.BAD_REQUEST;
            case RANKING_EVALUATION_EXPIRED -> HttpStatus.GONE;
            ...
            case MEDIA_ACCESS_UNAVAILABLE, RECOMMENDATION_INVENTORIES_UNAVAILABLE ->

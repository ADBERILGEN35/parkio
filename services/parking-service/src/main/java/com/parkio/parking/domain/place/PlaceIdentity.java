...
/**
 * Provider-neutral optional identity for a place.
 *
 * <p>Coordinates remain the fallback identity basis when this is absent.
 * Provider IDs stay namespaced; this package does not fuse identities across
 * providers.
 */
public record PlaceIdentity(String provider, String providerPlaceId) {

    /** Nominatim / OSM geocoder namespace used by parking-service today. */
    ...
    /**
     * Deterministic namespaced key: {@code provider:providerPlaceId}.
     * Equality of identities is still based on the two fields; this key is the
     * stable external form for caches and future place graphs.
     */
    ...
    public static PlaceIdentity osmNominatim(String providerPlaceId) {
        return new PlaceIdentity(PROVIDER_OSM_NOMINATIM, providerPlaceId);
    }

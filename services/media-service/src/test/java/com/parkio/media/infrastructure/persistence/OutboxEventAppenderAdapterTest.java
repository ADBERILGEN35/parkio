...
class OutboxEventAppenderAdapterTest {
    ...
    void persistsPayloadEventIdIntoEventIdColumn() {
        ...
        MediaRejectedEvent event = new MediaRejectedEvent(
                eventId, UUID.randomUUID(), UUID.randomUUID(), MediaValidationType.DUPLICATE,
                "duplicate", "checksum", Instant.parse("2026-06-08T12:00:00Z"));

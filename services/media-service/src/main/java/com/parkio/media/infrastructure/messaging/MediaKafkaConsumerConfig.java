...
@Configuration
public class MediaKafkaConsumerConfig {

    public static final String DLT_MEDIA = "parkio.dlt.media";

    private final String bootstrapServers;
    private final boolean autoStartup;

    public MediaKafkaConsumerConfig(
    ...
    @Bean
    ConsumerFactory<String, String> mediaConsumerFactory() {
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, String> mediaKafkaListenerContainerFactory(
            ConsumerFactory<String, String> mediaConsumerFactory,
        ...
        DeadLetterPublishingRecoverer recoverer = new DeadLetterPublishingRecoverer(
                kafkaTemplate, (record, ex) -> new TopicPartition(DLT_MEDIA, -1));

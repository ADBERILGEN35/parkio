...
/**
 * Kafka consumer wiring for the parking events gamification subscribes to. The envelope
 ...
 * backoff; exhausted/poison records are published to {@code parkio.dlt.gamification} so a
 * single bad message never blocks the partition.
 */
@Configuration
public class GamificationKafkaConsumerConfig {
    ...
    public GamificationKafkaConsumerConfig(

...
**Closeout implementation:** `7dda96723f2d6e64f8790f6fd38aa92663f950d7`
...
`Secret scan`. Closeout-head required and dedicated checks are on the
pushed tip (see the PR checks for this SHA).
...
3. **Exporter scheduling** -- independent lock-protocol job, not
   nightly-backup-only.
4. **Freshness monitoring** -- watermark-age alert; backup COMPLETE is
   not coverage.

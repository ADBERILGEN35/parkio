...
describe('rankingEvaluationCorrelation (mobile-v2)', () => {
  const recordRankingEvaluationOutcome = jest.fn().mockResolvedValue({ status: 'RECORDED' });
  ...
  it('binds evaluationId and records selected ordinal', () => {

/**
 * Privacy-safe ranking evaluation correlation (WP-SPA-14B) for web.
...
const PLATFORM: RankingEvaluationPlatform = 'WEB';
...
/** Records NAVIGATION_STARTED (or other types) for the currently selected candidate. */

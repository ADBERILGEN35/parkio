...
public final class KafkaTraceContextSupport {
    ...
    public static final String CORRELATION_ID = PlatformHeaders.MDC_CORRELATION_ID;
    public static final String EVENT_ID = PlatformHeaders.MDC_EVENT_ID;
    public static final String TRACEPARENT = PlatformHeaders.TRACEPARENT;
    public static final String TRACESTATE = PlatformHeaders.TRACESTATE;
    public static final String BAGGAGE = PlatformHeaders.BAGGAGE;
    ...
    public static void putCorrelationAndEventMdc(Iterable<Header> headers, String envelopeTraceId) {
        putMdc(CORRELATION_ID, firstNonBlank(headerValue(headers, PlatformHeaders.KAFKA_LEGACY_TRACE_ID), envelopeTraceId));

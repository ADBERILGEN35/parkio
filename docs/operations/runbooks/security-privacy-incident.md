#  security privacy incident.Groups[1].Value + security privacy incident.Groups[2].Value.ToUpper() ecurity security privacy incident.Groups[1].Value + security privacy incident.Groups[2].Value.ToUpper() rivacy security privacy incident.Groups[1].Value + security privacy incident.Groups[2].Value.ToUpper() ncident
...
Isolate; preserve evidence; rotate keys

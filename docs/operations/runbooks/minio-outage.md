#  minio outage.Groups[1].Value + minio outage.Groups[2].Value.ToUpper() inio minio outage.Groups[1].Value + minio outage.Groups[2].Value.ToUpper() utage
...
Spot photos unavailable

## Immediate safety action

Disable upload UX if needed
...
Restore MinIO or backup mirror

...
| R24 | Relevant unit tests exist. | **PARTIAL** | Backend deletion + lifecycle + deletion-event producer/consumer tests; mobile-v2 S1-P0-02/03/04/10/11; **Web** ParkingSession focused tests (WP-07.2). Hosted-beta smoke still incomplete (R27). | Sprint 1 deploy/device proof remains incomplete. |

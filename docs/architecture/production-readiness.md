...
rate limits (`TOOMANYREQUESTS`) and scanner-version drift. Trivy is not installed on the GitHub
runner. To update Trivy, change `TRIVY_IMAGE` in `.github/workflows/security-ci.yml` and rerun
